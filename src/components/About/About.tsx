        ...
        <section className="about_me__root">
          <div className="about_me_root__memoji">
            <MediaQuery minWidth={250} maxWidth={992}>
              <img
                src={require('../../assets/Group 1923.svg').default}
                alt=""
              />
            </MediaQuery>
            <MediaQuery minWidth={993}>
              <img
                src={require('../../assets/Group 1919.svg').default}
                alt=""
              />
          ...
          <div className="about_me__details">
            ...
            <div className="about_me_details__intro">
              <p>
                ...
                hobby years ago, and now I work as a professional UI/UX
                designer. During this time, I've learnt and collaborated with
                clients from a variety of backgrounds and industries to improve
                experiences through design. I am passionate about solving
                problems and providing solutions that are simple and elegant and
                turning any ideas into elegantly packed, ready-to-use products
                with high-quality designs and uniqueness!
                <br />
                <br />
                <br />
